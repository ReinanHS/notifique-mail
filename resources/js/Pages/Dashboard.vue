    ...
    <app-layout title="Dashboard">
        ...
        <main class="h-screen flex flex-col space-y-2 items-center justify-center bg-gray-50">
            <div class="flex flex-col items-center justify-center"><p
                class="text-center text-xl text-gray-500">Olá seja bem vindo!</p>
                <h1 class="font-bold text-center text-4xl text-indigo-500">🤖 Para enviar um email clique no botão</h1>
                <p class="text-center text-xl text-gray-500 mt-3">Ao clicar no botão sera enviado um: ⬇️</p>
                <ul>
                    <li class="text-center text-sl text-gray-400 mt-3">Email</li>
                    <li class="text-center text-sl text-gray-400 mt-3">Push notification</li>
                </ul>
                <div>
                    <svg class="opacity-20 ml-16 mt-6" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px"
                         y="0px" width="100" height="100" viewBox="0 0 415.262 415.261"
                         style="enable-background: new 0 0 415.262 415.261;" xml:space="preserve">
                                      <g>
                                        <path
