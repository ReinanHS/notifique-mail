            ...
            <ul class="mt-6">
                <li class="py-5 border-b px-3 transition hover:bg-indigo-100">
                    <a href="#" class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold">Reinan Gabriel</h3>
                        <div class="flex flex-col items-end ">
                            <p class="text-md text-gray-400">23m ago</p>
                            <span class="mt-1 w-2 h-2 bg-blue-400 rounded-full"></span>
                        </div>
                    </a>
                    <div class="text-md italic text-gray-400">Você foi convidado!</div>
                </li>
            </ul>
        </section>
        <section class="w-7/12 px-4 flex flex-col bg-white rounded-r-3xl overflow-y-scroll max-h-full">
            <div class="flex justify-between items-center min-box-user border-b-2 mb-8">
                <div class="flex space-x-4 items-center">
                    ...
                    <div class="flex flex-col">
                        <h3 class="font-semibold text-lg">Reinan Gabriel</h3>
                        <p class="text-light text-gray-400">reinangabriel1520@gmail.com</p>
                    </div>
                </div>
                <div>
            ...
            <section class="">
                <h1 class="font-bold text-2xl">Precisamos de um designer de UI / UX</h1>
                <article class="mt-8 text-gray-500 leading-7 tracking-wider">
                    <p>Olá Reinan,</p><br>
                    <p>
                        Si u mundo tá muito paradis? Toma um mé que o mundo vai girarzis! Mauris nec dolor in eros commodo tempor. Aenean aliquam molestie leo, vitae iaculis nisl.
                        Posuere libero varius. Nullam a nisl ut ante blandit hendrerit. Aenean sit amet nisi. Nec orci ornare consequat. Praesent lacinia ultrices consectetur. Sed non ipsum felis.
                    </p><br>
                    <p>
                        Admodum accumsan disputationi eu sit. Vide electram sadipscing et per. Em pé sem cair, deitado sem dormir, sentado sem cochilar e fazendo pose.
                        Mais vale um bebadis conhecidiss, que um alcoolatra anonimis. Vehicula non. Ut sed ex eros. Vivamus sit amet nibh non tellus tristique interdum.
                    </p>
                    <footer class="mt-12">
